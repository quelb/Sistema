			...
			<section id="main" class="wrapper">
				<div class="inner">
					...
					<!-- Content -->
						...
						<h2 id="content">Como pagar a assinatura?</h2>
						<p>A forma de pagamento para os assinantes é pelo cartão de crédito. A cada mês será descontada a mensalidade do plano.</p> 
